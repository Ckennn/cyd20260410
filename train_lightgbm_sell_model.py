...
OUTPUT_FILE = project_paths.get_debug_cache_file("industry_parameters_lightgbm_sell.csv")
...
def feature_engineering(df):
    ...
    df['heat_price_divergence'] = df['sig_ma5'] - (df['roc_5'] * 100) 
...
def train_and_predict(df, feature_cols):
    """
    滚动窗口训练与预测 (Sell Model) - Using LightGBM
    """
    ...
    print(f"🚀 开始滚动训练 Sell Model (LightGBM, 窗口={TRAIN_WINDOW}天)...")
